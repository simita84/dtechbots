...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { bk_name: @inventory.bk_name, bk_price: @inventory.bk_price, bk_qty: @inventory.bk_qty }
    end
  ...
  test "should update inventory" do
    put :update, id: @inventory, inventory: { bk_name: @inventory.bk_name, bk_price: @inventory.bk_price, bk_qty: @inventory.bk_qty }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
